...
#[acmd_script( agent = "kamui", scripts = [ "game_attacks4", "game_attacks4hi", "game_attacks4lw" ], category = ACMD_GAME )]
...
#[acmd_script( agent = "kamui", scripts = [ "effect_attacks4", "effect_attacks4hi", "effect_attacks4lw" ], category = ACMD_EFFECT )]
unsafe fn kamui_fsmash_fx(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        macros::FOOT_EFFECT(fighter, Hash40::new("sys_dash_smoke"), Hash40::new("top"), -9, 0, 0, 0, 0, 0, 0.7, 0, 0, 0, 0, 0, 0, false);
    }
...
unsafe fn kamui_fsmash_charge_fx(fighter: &mut L2CAgentBase) {
    ...
    macros::EFFECT(fighter, Hash40::new("sys_smash_flash_s"), Hash40::new("haver"), 0, 1.5, 2, 0, 0, 0, 1, 4, 4, 4, 0, 0, 0, true);
}
